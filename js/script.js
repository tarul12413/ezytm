		...
		Basic: {
			...
			SideInner: function (){
				$('.sidebar-switcher').on("click", function() {
					$('.ezytm-side-inner').toggleClass("sidebar-on");
				});
				$('.sidebar-switcher').on('click', function () {
			...
			GoogleMap: function (){
				if ( $('#ezytm_map').length ){
					var $lat = $('#ezytm_map').data('lat');
					var $lon = $('#ezytm_map').data('lon');
					var $zoom = $('#ezytm_map').data('zoom');
					var $marker = $('#ezytm_map').data('marker');
					var $info = $('#ezytm_map').data('info');
					var $markerLat = $('#ezytm_map').data('mlat');
					var $markerLon = $('#ezytm_map').data('mlon');
					var map = new GMaps({
						el: '#ezytm_map',
						lat: $lat,
						lng: $lon,
